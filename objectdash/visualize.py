...
def visualize_annotation(image_np, annotations):
    ...
    image_path = os.path.join("annotations/", image_id + '.jpg')
    image_name = os.path.join(settings.MEDIA_ROOT, image_path)
...
def crop_annotations(image_np, annotations):
    ...
    for annotation in annotations:
        ...
        image_id = str(uuid.uuid4())
        image_path = os.path.join("annotations/crops/", image_id + '.jpg')
        image_name = os.path.join(settings.MEDIA_ROOT, image_path)
